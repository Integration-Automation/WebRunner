...
<p align="center">
  ...
  <a href="https://github.com/Integration-Automation/WebRunner/blob/main/LICENSE"><img src="https://img.shields.io/github/license/Integration-Automation/WebRunner" alt="License"></a>
...
Every `utils/` subpackage with a one-line summary, grouped into the core engine, the
`je_web_runner.api` facade themes and the rest: [`docs/reference/utils_index.md`](docs/reference/utils_index.md)
(generated by `scripts/gen_utils_index.py`).
